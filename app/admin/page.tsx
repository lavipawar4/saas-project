        ...
        <>
            <div className="flex justify-between items-end mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div>
                    ...
                    <p className="text-[#a3aed1] text-sm">System performance and AI response stats.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <StatCard 
                    ...
                    value={stats.reviewsSynced.toLocaleString()} 
                ...
                <StatCard 
                    ...
                    value={stats.connectedLocations.toLocaleString()} 
                    icon={<div className="w-12 h-12 rounded-full bg-[#FFCE20]/10 flex items-center justify-center text-[#FFCE20]"><MapPin className="w-5 h-5" /></div>}
                    trend="new locations"
                    trendValue="+12"
                    trendUp={true}
                ...
                <StatCard 
                    ...
                    icon={<div className="w-12 h-12 rounded-full bg-[#01B574]/10 flex items-center justify-center text-[#01B574]"><CreditCard className="w-5 h-5" /></div>}
                    trend="new pro users"
                    trendValue="+3"
                    trendUp={true}
